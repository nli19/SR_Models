...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.enc_dense.add_module('fc4', nn.Linear(in_features=200 * 51 * 51, out_features=1024))
        ...
        self.rec_dense.add_module('fc4_', nn.Linear(in_features=1024, out_features=200 * 51 * 51))
    ...
    def forward(self, input_data):
        ...
        feat_encode = feat_encode.view(-1, 200, 51, 51)
        img_rec = self.rec_feat(feat_encode)

        return img_rec

# model = MyModel()
# ii = torch.randn((2,3,204,204))
# out = model(ii)
# print(out.size())